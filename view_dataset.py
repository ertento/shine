    ...
    for idx in range(dataset.len()):
        ...
        if cfg.dataset.view == 'all' or cfg.dataset.view == 'predicted':
            ...
            for bbox in predicted_boxes[file_name]:
                ...
                cv2.rectangle(im, (x, y), (x+widht, y+height), ( 0, 255, 0), 1)
                #cv2.rectangle(im, (x, y), (x+widht, y+height), ( rm.randint(0,255), rm.randint(0,255),rm.randint(0,255)),rm.randint(0,2))
